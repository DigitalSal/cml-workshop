...
***********START - Skip this Section if you found the Cloudera Machine Learning Workshop AMPS ****************
- If you don't see a *Cloudera Machine Learning Workshop* AMP, click on *Projects* on the left-side panel
+
--
** Click on the *New Project* button on the right side of the screen
...
--
***********END Skip this Section if you found the Cloudera Machine Learning Workshop AMPS ****************
