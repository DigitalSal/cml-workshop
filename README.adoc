...
** HIVE_DATABASE: `<unique username/value>` For example, cdpuser50
** HIVE_TABLE: `churn_prototype`
//** HIVE_TABLE: `<unique username/value>` For example, cdpuser50
--
+
...
* Click on *Model Deployments* in the side panel
* Click on *New Model* 
...
* Give your application a name (`Churn Model Explainer`), and provide a _unique_ subdomain
