...
+
image::./images/lab9/lab9-3.png[width=300]
+
...
* Retrieve an API key from *User Settings*  > API Keys > *Create API Key*
+
...
* Use *list_jobs()* and *create_job_run(...)* functions to kick off the job we created in Lab 4. For reference, see https://docs.cloudera.com/machine-learning/cloud/api/topics/ml-apiv2-usage-examples.html[API v2 Usage].
